/**
 * @file 	4.2.1 Ball Collision with Ground.cpp
...
// observer location
StdVec<Vecd> observation_location_1 = {Vec3d(0.25 * DL, 0.3 * DL, 0.75 * DH)};
StdVec<Vecd> observation_location_2 = {Vec3d(0.25 * DL, 0.7 * DL, 0.75 * DH)};
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    RegressionTestDynamicTimeWarping<ObservedQuantityRecording<Vecd>>
        ball_1_displacement_recording("Position", io_environment, ball_1_observer_contact);
    RegressionTestDynamicTimeWarping<ObservedQuantityRecording<Vecd>>
        ball_2_displacement_recording("Position", io_environment, ball_2_observer_contact);
    //----------------------------------------------------------------------
    ...
    ball_1_displacement_recording.writeToFile(0);
    ball_2_displacement_recording.writeToFile(0);
    //----------------------------------------------------------------------
    ...
    while (GlobalStaticVariables::physical_time_ < end_time)
    {
        ...
        while (integration_time < output_interval)
        {
            ...
            ball_1_displacement_recording.writeToFile(ite);
            ball_2_displacement_recording.writeToFile(ite);
        }
    ...
    ball_1_displacement_recording.testResult();
    ball_2_displacement_recording.testResult();
