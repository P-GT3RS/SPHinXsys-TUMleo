/**
 * @file 	4.2.3 Shaving Cream Drop.cpp
 * @details shaving cream adhering to the platform falls due to gravity
...
class Cream : public ComplexShape
{
  public:
    ...
    {
        Vec3d translation_cream(0.0, 0.0, DH / 2.0);
        add<TriangleMeshShapeSTL>(full_path_to_file, translation_cream, 0.2);
    }
};
//----------------------------------------------------------------------
