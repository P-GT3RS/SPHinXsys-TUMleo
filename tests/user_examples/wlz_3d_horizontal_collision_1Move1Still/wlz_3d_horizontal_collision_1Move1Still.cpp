...
Vec3d halfsize(1.5, 1.5, 0.1);
Vec3d ball_center_1(-1.0, 0.0, 2.5);
Vec3d ball_center_2(1.0, 0.0, 2.5);
BoundingBox system_domain_bounds(Vec3d(-4.0, -2.0, -0.5),
                                 Vec3d(4.0, 2.0, 4.0));
Real ball_radius_1 = 0.5;
Real ball_radius_2 = 0.4;
// Real resolution_ref = 0.005;/**< reference resolution. */
// Vec3d ball_center_1(-0.1, 0.0, 0.25);
// Vec3d ball_center_2(0.1, 0.0, 0.25);
// BoundingBox system_domain_bounds(Vec3d(-0.4, -0.2, -0.05),
//	Vec3d(0.4, 0.2, 0.4));
// Real ball_radius = 0.05;
...
//----------------------------------------------------------------------
// two balls are viscoplastic material.
...
int main(int ac, char *av[])
{
    ...
    ReduceDynamics<solid_dynamics::AcousticTimeStepSize> ball_get_time_step_size_1(ball_1, 0.05);
    ReduceDynamics<solid_dynamics::AcousticTimeStepSize> ball_get_time_step_size_2(ball_2, 0.05);
