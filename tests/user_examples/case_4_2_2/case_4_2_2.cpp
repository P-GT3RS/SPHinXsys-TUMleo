/**
 * @file 	4.2.2 Ball Collision with Cylinder.cpp
 * @details one ball with pie material collides with two cylinders. The gravity varies from 2.0 to 4.0 and 8.0.
...
// observer location
StdVec<Vecd> observation_location = {Vec3d(0.0, 0.0, 0.5 * DH)};
//----------------------------------------------------------------------
//	Global parameters on material properties
//----------------------------------------------------------------------
Real gravity_g = 2.0;
Real rho0_s = 275.0;                                                                                    /* ¦Ñ density. kg/m^3 */
Real Bulk_modulus = 1.09e5;                                                                             /* ¦Ê bulk modulus. Pa */
Real Shear_modulus = 1.6e3;                                                                             /* ¦Ì/G shear modulus. Pa */
...
Real yield_stress = 120.0;                                                                              /* ¦Ò_Y yield stress. Pa */
Real viscosity = 5.0;                                                                                   /* ¦Ç viscosity. */
Real Herschel_Bulkley_power = 0.27;
//----------------------------------------------------------------------
//	Geometric shapes
//----------------------------------------------------------------------
